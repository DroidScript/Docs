...
function SObj( id )
{
	...
	this.id = id;
	this.data = {};
	this.Destroy  = function() { prompt( this.id, "SObj.Release(" ); _map[this.id] = null; } 
    this.Release  = function() { prompt( this.id, "SObj.Release(" ); _map[this.id] = null; } 
    this.Method  = function(name,types,p1,p2,p3,p4) { return prompt( this.id, "SObj.Method(\f"+name+"\f"+types+"\f"+p1+"\f"+p2+"\f"+p3+"\f"+p4 );  }       
}
...
function Obj( id )
{
    ...
    /*#obj*/ this.GetParent = function() { return this._parent; } 
    /*#obj*/ this.Method  = function(name,types,p1,p2,p3,p4) { return prompt( this.id, "Obj.Method(\f"+name+"\f"+types+"\f"+p1+"\f"+p2+"\f"+p3+"\f"+p4 );  }             
    ...
    /*#obj*/ this.GetWidth  = function( options ) { return parseFloat(prompt( this.id, "Obj.GetWidth(\f"+options )); }  
    /*#obj*/ this.GetHeight  = function( options ) { return parseFloat(prompt( this.id, "Obj.GetHeight(\f"+options )); }   
    /*#obj*/ this.GetAbsWidth  = function() { return parseInt(prompt( this.id, "Obj.GetAbsWidth(" )); }  
    /*#obj*/ this.GetAbsHeight  = function() { return parseInt(prompt( this.id, "Obj.GetAbsHeight(" )); }   
    /*#obj*/ this.GetLeft  = function( options ) { return parseFloat(prompt( this.id, "Obj.GetLeft(\f"+options )); }  
    /*#obj*/ this.GetTop  = function( options ) { return parseFloat(prompt( this.id, "Obj.GetTop(\f"+options )); }   
...
function Lay( id )
{
    ...
    obj.SetTouchThrough = function( through ) { prompt( obj.id, "Lay.SetTouchThrough(\f"+through ); }
...
function Txe( id )
{
    ...
    obj.SetOnFocus = function( callback ) { prompt( obj.id, "Txe.SetOnFocus(\f"+_Cbm(callback) ); }  
...
function Web( id )
{
    ...
    obj.SetZoom = function( zoom ) { prompt( obj.id, "Web.SetZoom(\f"+zoom ); }
    obj.SetTextZoom = function( zoom ) { prompt( obj.id, "Web.SetTextZoom(\f"+zoom ); }
    ...
    obj.SetOnTouch = function( callback ) { prompt( obj.id, "Web.SetOnTouch(\f"+_Cbm(callback) ); } 
    return obj;
}
...
{
    var obj = new Obj( id );   
    obj.GetType = function() { return "Overlay"; }
    obj.AddLayout = function( layout,left,top,options ) { prompt( obj.id, "Ovl.AddLayout(\f"+(layout?layout.id:null)+"\f"+left+"\f"+top+"\f"+options ); }	
	obj.RemoveLayout = function( layout ) { prompt( obj.id, "Ovl.RemoveLayout(\f"+(layout?layout.id:null) ); }
	obj.SetPosition = function( layout,left,top,options ) { prompt( obj.id, "Ovl.SetPosition(\f"+(layout?layout.id:null)+"\f"+left+"\f"+top+"\f"+options ); }	
	return obj;
}
...
function Net( id )
{
    ...
    obj.Close = function() { prompt( obj.id, "Net.Disconnect(" ); }
...
function WGL( id )
{
    ...
    obj.Execute = function( js ) { prompt( obj.id, "WGL.Execute(\f"+js ); } 
...
function Not( id )
{
	...
	obj.SetSmallImage = function( image ) { if( image.id ) prompt( obj.id, "Not.SetSmallImage(\f"+(image?image.id:null) ); 
...
function Wbs( id )
{
    ...
    obj.SendText = function( txt,ip,id ) { prompt( obj.id, "Wbs.SendText(\f"+txt+"\f"+ip+"\f"+id ); }
...
function Sys( id )
{
	...
	obj.Destroy  = function() { prompt( obj.id, "Sys.Destroy(" ); _map[obj.id] = null; } 
    ...
    obj.SetOnInput = function( callback ) { prompt( obj.id, "Sys.SetOnInput(\f"+_Cbm(callback) ); }  
    obj.SetOnError = function( callback ) { prompt( obj.id, "Sys.SetOnError(\f"+_Cbm(callback) ); }  
    return obj;
}
...
function Fil( id )
{
    ...
    obj.ReadTextAsync = function( type,callback ) { return prompt( obj.id, "Fil.ReadTextAsync(\f"+type+"\f"+_Cbm(callback) ); }
...
function Svc( id )
{
	...
	obj.SetInForeground = function( title,text,largeIcon,smallIcon,importance ) { prompt( obj.id, "Svc.SetInForeground(\f"+title+"\f"+text+"\f"+largeIcon+"\f"+smallIcon+"\f"+importance ); }
	obj.SetInBackground = function() { prompt( obj.id, "Svc.SendMsg(\f"+"_background" ); }
    return obj;
}
...
app = new App();
cfg = {Game:0, Landscape:0, Portrait:0, NoDom:0, Transparent:0, Share:0, USB:0, GLES:0 }
