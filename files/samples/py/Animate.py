...
def OnStart():
    ...
    types = ["NewsPaper", "Jelly", "Flash", "RubberBand", "ShakeHorizontal", "ShakeVertical", "Swing", "TaDa",
             ...
             "FadeIn", "FadeOut",
             "Fall", "FallRotate",
             "FlipFromVerticalSwing", "FlipFromHorizontal", "FlipFromBottom", "FlipFromVertical",
             "FlipFromHorizontalSwing", "FlipFromTop", "FlipFromRight", "FlipFromLeft", "FlipToHorizontal",
             "FlipToVertical",
             "SlideFromLeft", "SlideFromTop", "SlideFromRight", "SlideFromBottom", "SlideToLeft", "SlideToTop",
             "SlideToRight", "SlideToBottom",
             "ScaleFromLeft", "ScaleFromTop", "ScaleFromRight", "ScaleFromBottom", "ScaleToLeft", "ScaleToTop",
             "ScaleToRight", "ScaleToBottom",
