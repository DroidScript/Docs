...
var backGroundX = 0;
var backGroundShift = 0.001;

//Init character variables.
var charX=0.25, charY=0.5;
var charW=0.07, charH=0.18;

//Set flying object positions and speed.
var obj1X=1.0, obj1Y=0.1, obj1W=0.06, obj1H=0.3, obj1Speed=2/bmpW;
var obj2X=1.3, obj2Y=0.6, obj2W=0.06, obj2H=0.3, obj2Speed=4/bmpW;
...
function DrawFrame()
{
    ...
    if( obj1X <= 0 ) obj1X = 1.0; else obj1X -= obj1Speed;
    canvas.DrawImage( imgobj, obj1X+0.015, obj1Y, obj1W, obj1H )
    
    //Move and draw object 2.
    if( obj2X <= 0 ) obj2X = 1.0; else obj2X -= obj2Speed;
...
function GameOver()
{
    ...
    canvas.DrawText( "Game Over!", 0.4, 0.5 )
    app.Animate( null )
}
