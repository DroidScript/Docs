...
//Note: You must pair with the other device before using
//this sample. You can use the 'Bluetooth Select' sample on
//another device as the client device.
...
function bt_OnConnect( name, address )
{
...
function bt_OnDisconnect( name, address )
{
    console.log( name + " disconnected @ " + address )
}
