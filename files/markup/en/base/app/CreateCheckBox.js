...
// CreateCheckBox.md --> Complete documentation. Sample codes is at the bottom of this file.
...
/** ## Methods ##
 * These are the methods available for CreateCheckBox
 */
 ...
 * $$ chk.SetMargins(left, top, right, bottom, mode) $$
 * @param {num_frc} left 
 * @param {num_frc} top 
 * @param {num_frc} right 
 ...
 * $$ chk.SetPadding(left, top, right, bottom, mode) $$
 * @param {num_frc} left 
 * @param {num_frc} top 
 * @param {num_frc} right 
 * @param {num_frc} bottom 
 ...
 * $$ chk.SetSize(width, height, options) $$
 * @param {num} width 
 * @param {num} height 
...
// CreateCheckBox.txt --> All the sample codes
