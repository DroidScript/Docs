     ...
     * @prop {String} animateIn Sets or returns the control animation when shown.
     * @prop {String} animateOut Sets or returns the control animation when hidden.
     * @prop {Number} animateDuration Sets or returns the control animation duration for both showing and hiding.
     */
    ...
    /** ### addClass
     * @name addClass
     * Add new class or classes to the control's container element.
     * $$ cname.addClass( cls )
     * @param {String} cls Class name or names. For multiple classes just separate them with a space e.g. “my-button my-button-large”
     */
     ...
     * $$ cname.setOnContextMenu( callback ) $$
